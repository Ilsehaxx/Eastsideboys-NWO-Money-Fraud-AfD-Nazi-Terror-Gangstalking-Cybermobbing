# Operazione di Influenza della GRU: Radicalizzando la Gioventù Tedesca Attraverso Neonazisti e Motociclette Simson

## Panoramica
Questo repository documenta le accuse di un'operazione di influenza russa della GRU (Direttorato Principale di Intelligence) mirata a radicalizzare la gioventù in Germania. L'operazione presumibilmente sfrutta simboli neonazisti e il marchio delle motociclette Simson per promuovere l'estremismo di estrema destra, in particolare attraverso il partito Alternativa per la Germania (AfD).

## Sfondo sulle Motociclette Simson
- Fondata nel 1856 dai fratelli ebrei Löb e Moses Simson.
- L'azienda fu costretta a vendere ai nazisti negli anni '30, e la famiglia fuggì dalla Germania.
- Le motociclette Simson divennero iconiche nella Germania Est durante l'era della DDR.
- Negli ultimi anni, l'AfD ha appropriato il marchio per simbolismo politico, guidando motociclette Simson agli eventi e utilizzandole nella propaganda.
- I discendenti della famiglia Simson hanno condannato questo come "insultante" e "appropriazione" di un'eredità ebraica.
